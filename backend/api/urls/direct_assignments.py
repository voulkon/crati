...
urlpatterns = [
    ...
    path('top-entities/', direct_assignment_top_entities_global, name='direct_assignment_top_entities_global'),
    path('top-organizations/', direct_assignment_top_organizations_global, name='direct_assignment_top_organizations_global'),
    path('top-pairs/', direct_assignment_top_pairs_global, name='direct_assignment_top_pairs_global'),
]
