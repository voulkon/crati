"""
Pre-calculation for decisions/top-direct-assignments/ endpoint.

Two-layer design:
  compute_top_direct_assignments(…)    → pure DB query
  warm_top_direct_assignments_window(…) → calls compute + caches under exact Redis keys
"""
