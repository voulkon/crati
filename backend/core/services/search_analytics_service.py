...
class SearchAnalyticsService:
    ...
    @classmethod
    def log_search_start(cls, query, search_types=None, entity_type=None, entity_id=None, 
                        request=None, filters_applied=None):
    ...
    def get_popular_queries(cls, entity_type=None, limit=10, min_searches=2):
        ...
        qs = PopularQuery.objects.filter(
            search_count__gte=min_searches
        )
    ...
    def get_query_suggestions(cls, partial_query, entity_type=None, limit=5):
        ...
        qs = PopularQuery.objects.filter(
            normalized_query__startswith=partial_query.lower(),
            search_count__gte=2
        )
