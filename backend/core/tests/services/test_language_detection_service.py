...
class TestSearchWeights:
    ...
    @pytest.mark.parametrize("test_id,test_case,category", [
    ...
    def test_greek_query_prioritizes_greek_fields(self):
        ...
        greek_weight, latin_weight = LanguageDetectionService.get_search_weights('ΔΗΜΟΣ')
    ...
    def test_latin_query_prioritizes_latin_fields(self):
        ...
        greek_weight, latin_weight = LanguageDetectionService.get_search_weights('Athens')
    ...
    def test_mixed_query_balanced_weights(self):
        ...
        greek_weight, latin_weight = LanguageDetectionService.get_search_weights('ΔΗΜΟΣ Athens')
        assert greek_weight == 'A'
        assert latin_weight == 'B'
    
    def test_neutral_query_balanced_weights(self):
        """Neutral queries (numbers) should have balanced weights"""
        greek_weight, latin_weight = LanguageDetectionService.get_search_weights('123456')
        assert greek_weight == 'A'
        assert latin_weight == 'B'
...
class TestPerformance:
    ...
    def test_performance_many_detections(self):
        ...
        assert elapsed < 1.0, f"Performance issue: {elapsed:.2f}s for {len(test_texts)} detections"
...
class TestSummary:
    ...
    def test_print_test_summary(self):
        ...
        print("  1. Edit existing JSON files in: backend/core/tests/data/language_detection/")
