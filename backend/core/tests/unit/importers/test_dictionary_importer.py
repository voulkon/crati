...
@pytest.mark.fast
def test_dictionary_to_defaults_mapping(
    dictionary_dto,
    expected_dictionary_defaults
):
    imp = DictionaryListImporter()
    defaults = imp._to_defaults(dictionary_dto)
    assert defaults == expected_dictionary_defaults, f"Expected {expected_dictionary_defaults}, but got {defaults}"
...
def test_dictionary_item_to_defaults_mapping(
    dictionary_item_dto,
    expected_dictionary_item_defaults
):
    ...
    assert are_the_same, f"Expected {expected_dictionary_item_defaults}, but got {defaults}"