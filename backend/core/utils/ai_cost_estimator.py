...
class AICostEstimator:
    ...
    def estimate_analysis_cost(
        ...
        overhead_ratio = Decimal(str(custom_overhead)) if custom_overhead is not None else Decimal('0.05')
        ...
        if pricing:
            ...
            input_cost = Decimal(str(input_tokens_with_overhead)) * input_price_per_token
    ...
    def estimate_extraction_batch_cost(
        ...
        ).only('id', 'raw_text', 'character_count')
