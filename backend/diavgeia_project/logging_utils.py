...
class TaskLogger(ContextLogger):
    ...
    def log_task_success(self, task_name: str, task_id: str, duration_s: float, result=None):
        """Log task success"""
        context = {
            'task_name': task_name,
            'task_id': task_id,
    ...
    def log_task_failure(self, task_name: str, task_id: str, duration_s: float, error: Exception):
        """Log task failure"""
        context = {
            'task_name': task_name,
            'task_id': task_id,
    ...
    def _safe_serialize(self, obj) -> str:
        ...
        try:
            return json.dumps(obj, cls=DjangoJSONEncoder, default=str)[:1000]  # Truncate
