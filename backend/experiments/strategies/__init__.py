...
class StrategyRegistry:
    ...
    def discover_strategies(cls):
        ...
        for importer, modname, ispkg in pkgutil.iter_modules(strategies_package.__path__):
            ...
            try:
                ...
                for name, obj in inspect.getmembers(module, inspect.isclass):
                    if (issubclass(obj, DecompositionStrategy) and 
                        obj is not DecompositionStrategy and
                        hasattr(obj, 'name')):
