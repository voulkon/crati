...
from experiments.strategies.base import DecompositionStrategy, DecompositionResult
...
class SampleTester:
        ...
        for type_folder in os.listdir(self.samples_dir):
            ...
            for filename in os.listdir(type_path):
                ...
                try:
                    ...
                    results.append(SampleTestResult(
                        ada=ada,
    ...
    def compare_strategies(self, strategies: List[DecompositionStrategy]) -> List[Dict[str, Any]]:
    ...
    def get_failures(self, strategy: DecompositionStrategy, limit: int = 10) -> List[SampleTestResult]:
