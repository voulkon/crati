...
class CompanyResponse(BaseModel):
    ...
    coNamesEn: Optional[List[str]] = Field(default_factory=list, description="Company names in English")
    coTitlesEl: Optional[List[str]] = Field(default_factory=list, description="Company titles in Greek")
    coTitlesEn: Optional[List[str]] = Field(default_factory=list, description="Company titles in English")
