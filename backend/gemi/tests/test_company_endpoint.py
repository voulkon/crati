...
def test_search_happy_path(
    ...
    with vcr_cassette('search_company_happy_path.yaml'):
        ...
        print(f"First company: GEMI={first_item.gemh_number}, Name={first_item.name}, AFM={first_item.vat_number}")
        ...
        assert all(item.gemh_number for item in items), "All companies should have GEMI numbers"
        ...
        if matching_companies:
            ...
            print(f"No exact AFM match found. API returned {len(items)} related companies.")
