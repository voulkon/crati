...
class NotificationSubscriptionListSerializer(serializers.ModelSerializer):
    ...
    relationship_org_uid = serializers.CharField(source='relationship_org.uid', read_only=True)
    relationship_entity_afm = serializers.CharField(source='relationship_entity.afm', read_only=True)
    
    # Target labels (for display)
    organization_label = serializers.CharField(source='organization.label', read_only=True)
    entity_name = serializers.CharField(source='entity.name', read_only=True)
    relationship_org_label = serializers.CharField(source='relationship_org.label', read_only=True)
    relationship_entity_name = serializers.CharField(source='relationship_entity.name', read_only=True)
