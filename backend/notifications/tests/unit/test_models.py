...
class TestNotificationSubscriptionModel:
    ...
    def test_subscription_string_representation(self, notification_subscription):
        ...
        assert notification_subscription.user.username in string_repr or \
               notification_subscription.organization.label in string_repr
...
class TestNotificationModel:
    ...
    def test_notification_string_representation(self, notification):
        ...
        assert notification.decision.ada in string_repr or \
               notification.user.username in string_repr
    ...
    def test_notification_match_details_json_field(self, user, notification_subscription, decision):
