...
## Translation Status / Κατάσταση Μετάφρασης

| Document | English | Ελληνικά |
|----------|---------|----------|
| Main README | ✅ Complete | 🚧 In Progress |
| Documentation Index | ✅ Complete | 🚧 In Progress |
| Architecture | ✅ Complete | ⏳ Planned |
| Deployment Guide | ✅ Complete | ⏳ Planned |
| Environment Variables | ✅ Complete | ⏳ Planned |
| Component Docs | ✅ Complete | ⏳ Planned |

### Help Translate / Βοηθήστε στη Μετάφραση

We welcome contributions for Greek translations! See [CONTRIBUTING.md](../CONTRIBUTING.md) for guidelines.

Καλωσορίζουμε συνεισφορές για ελληνικές μεταφράσεις! Δείτε το [CONTRIBUTING.md](../CONTRIBUTING.md) για οδηγίες.
...
- [GitHub Repository](https://github.com/voulkon/crati)
- [Report an Issue](https://github.com/voulkon/crati/issues)
